...
**App Store status:** v1.0 rejected March 5, 2026 (4.2.2 Minimum Functionality). Adding native features for v1.1 resubmission. Tier 1 (Widgets) + Tier 2 (Siri/Shortcuts) complete. 3 widget types, 5 sizes, 3 App Intents with Siri phrases, modal sheet deep linking. Tested on iPhone 15 Pro Max. Bundle ID `com.nikhilsi.TourGraph`, App ID `6759991920`.
